...
class InvestmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create investment" do
    assert_difference('Investment.count') do
      post investments_url, params: { investment: { investment: @investment.investment, name: @investment.name, shares: @investment.shares } }
    end
  ...
  test "should update investment" do
    patch investment_url(@investment), params: { investment: { investment: @investment.investment, name: @investment.name, shares: @investment.shares } }
